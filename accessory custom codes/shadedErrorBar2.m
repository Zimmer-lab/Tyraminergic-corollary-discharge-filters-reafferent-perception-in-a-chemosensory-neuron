...
%%if you want to kill transparency:
%     transparent=0; 
% end
...
if length(lineProps)<2
if ~ischar(lineProps{:})& length(lineProps{:})==3
    H=plot(x,y,'color',lineProps{:});
end
else 
...
patchSaturation=0.55; %How de-saturated or transparent to make the patch
if transparent
    ...
    faceAlpha=1;
    patchColor=col+(1-col)*(1-patchSaturation*0.9);
...
P=patch(xP,yP,1,'facecolor',patchColor,...
              'edgecolor','none',...
              'facealpha',faceAlpha);
